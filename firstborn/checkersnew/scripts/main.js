    ...
    window.RuntimeInterface = class g {
        constructor(c) {
            ...
            !this._useWorker || "undefined" !==
                typeof OffscreenCanvas && navigator.userActivation && p() || (this._useWorker = !1);
        ...
        async _Init(c) {
            ...
            c.runtimeBaseUrl ? this._runtimeBaseUrl = c.runtimeBaseUrl : (k = location.origin, this._runtimeBaseUrl = ("null" === k ? "file:///" : k) + location.pathname, k = this._runtimeBaseUrl.lastIndexOf("/"), -1 !== k && (this._runtimeBaseUrl = this._runtimeBaseUrl.substr(0, k +
                1)));
        ...
        _GetWorkerURL(c) {
            c = this._workerScriptURLs.hasOwnProperty(c) ? this._workerScriptURLs[c] : c.endsWith("/workermain.js") && this._workerScriptURLs.hasOwnProperty("workermain.js") ? this._workerScriptURLs["workermain.js"] : "playable-ad" === this._exportType && this._localFileBlobs.hasOwnProperty(c.toLowerCase()) ? this._localFileBlobs[c.toLowerCase()] :
                c;
        ...
        async CreateWorker(c, k, l) {
            ...
            if ("cordova" === this._exportType && this._isFileProtocol) return c = await this.CordovaFetchLocalFileAsArrayBuffer(l.isC3MainWorker ? c : this._scriptFolder + c), c = new Blob([c], {
        ...
        async _InitDOM(c, k) {
            ...
            this._domHandlers = C.map(q => new q(this));
            this._FindRuntimeDOMHandler();
            var l = c.engineScripts.map(q => "string" === typeof q ? (new URL(q, this._runtimeBaseUrl)).toString() : q);
            ...
            for (let [q, t] of r)
                ...
                } else if ("scriptsInEvents.js" === q || q.endsWith("/scriptsInEvents.js")) t =
                    await this._MaybeGetCordovaScriptURL(t), await e(t);
        ...
        async _MaybeGetCordovaScriptURL(c) {
            return "cordova" ===
                this._exportType && (c.startsWith("file:") || this._isFileProtocol && this.IsRelativeURL(c)) ? (c.startsWith(this._runtimeBaseUrl) && (c = c.substr(this._runtimeBaseUrl.length)), c = await this.CordovaFetchLocalFileAsArrayBuffer(c), c = new Blob([c], {
                    type: "application/javascript"
        ...
        _RequestPermission(c) {
            ...
            return new Promise((l,
                n) => k.requestPermission(this._MapPermissionID(k, c), r => l(!!r.hasPermission), n))
        }
...
"use strict"; {
    ...
    d.AddDOMHandlerClass(class extends self.DOMHandler {
        constructor(f) {
            ...
            f.AddRuntimeComponentMessageHandler("runtime", "invoke-download",
                k => this._OnInvokeDownload(k));
            ...
            f.AddRuntimeComponentMessageHandler("runtime",
                "exported-to-video", k => this._OnExportedToVideo(k));
        ...
        _OnBeforeStartTicking() {
            ...
            "cordova" === this._iRuntime.GetExportType() ? (document.addEventListener("pause", () => this._OnVisibilityChange(!0)), document.addEventListener("resume", () => this._OnVisibilityChange(!1))) :
        ...
        Attach() {
            ...
            window.addEventListener("keydown", g => this._OnKeyEvent("keydown",
                g));
            ...
            }), this._iRuntime.UsesWorker() && "undefined" !== typeof window.onpointerrawupdate && self === self.top ? (this._pointerRawUpdateRateLimiter = new self.RateLimiter(() =>
            ...
            }), window.addEventListener("touchmove", g => this._OnTouchEvent("pointermove", g)), window.addEventListener("touchend", g => this._OnTouchEvent("pointerup", g)), window.addEventListener("touchcancel", g => this._OnTouchEvent("pointercancel",
                g)));
        ...
        _TrySetTargetOrientation() {
            ...
            if (screen.orientation && screen.orientation.lock) screen.orientation.lock(f).catch(g =>
        ...
        _OnMouseEventAsPointer(f, g) {
            if (!this._isExportToVideo && !a(g)) {
                ...
                "pointerdown" === f && 0 !== c ? f = "pointermove" : "pointerup" === f && 0 !== g.buttons &&
                    (f = "pointermove");
                this._PostToRuntimeMaybeSync(f, {
                    pointerId: 1,
                    pointerType: "mouse",
        ...
        _OnPointerEvent(f, g) {
            if (!this._isExportToVideo) {
                ...
                this._PostToRuntimeMaybeSync(f, {
                    ...
                    tangentialPressure: g.tangentialPressure ||
                        0,
                    tiltX: g.tiltX || 0,
                    tiltY: g.tiltY || 0,
                    twist: g.twist || 0,
        ...
        _OnPointerRawUpdate(f) {
            this._lastPointerRawUpdateEvent && (this._pointerRawMovementX += this._lastPointerRawUpdateEvent.movementX || 0, this._pointerRawMovementY += this._lastPointerRawUpdateEvent.movementY ||
                0);
        ...
        _OnUpdateCanvasSize(f) {
            ...
            g.IsExportingToVideo() || (g = g.GetCanvas(), g.style.width = f.styleWidth + "px", g.style.height = f.styleHeight +
                "px", g.style.marginLeft = f.marginLeft + "px", g.style.marginTop = f.marginTop + "px", this._isFirstSizeUpdate && (g.style.display = "", this._isFirstSizeUpdate = !1))
        }
        _OnInvokeDownload(f) {
            const g = f.url;
            f = f.filename;
        ...
        _OnWrapperMessage(f) {
            "entered-fullscreen" === f ? (d._SetWrapperIsFullscreenFlag(!0), this._OnFullscreenChange()) : "exited-fullscreen" === f ? (d._SetWrapperIsFullscreenFlag(!1), this._OnFullscreenChange()) : console.warn("Unknown wrapper message: ", f)
        }
...
"use strict"; {
    ...
    self.RuntimeInterface.AddDOMHandlerClass(class extends self.DOMElementHandler {
        ...
        CreateElement(b, e) {
            let h;
            const m = e.type;
            "textarea" === m ? (h = document.createElement("textarea"), h.style.resize = "none") : (h = document.createElement("input"), h.type = m);
            h.style.position = "absolute";
            h.autocomplete = "off";
            h.addEventListener("pointerdown", d);
            h.addEventListener("pointermove", d);
            h.addEventListener("pointerrawupdate", d);
            h.addEventListener("pointerup", d);
            h.addEventListener("mousedown", d);
            h.addEventListener("mouseup", d);
            ...
            h.addEventListener("input",
                () => this.PostToRuntimeElement("change", b, {
                    text: h.value
                }));
            e.id && (h.id = e.id);
        ...
        UpdateState(b, e) {
            ...
            b.title = e.title;
            b.disabled = !e.isEnabled;
            b.readOnly = e.isReadOnly;
            b.spellcheck = e.spellCheck;
            e = e.maxLength;
            0 > e ? b.removeAttribute("maxlength") : b.setAttribute("maxlength", e)
        }
        _OnScrollToBottom(b) {
...
self.RuntimeInterface.AddDOMHandlerClass(class extends self.DOMHandler {
    ...
    _GetSafeAreaInset() {
        ...
        d = [d.getPropertyValue("--temp-sai-top"), d.getPropertyValue("--temp-sai-right"), d.getPropertyValue("--temp-sai-bottom"),
            d.getPropertyValue("--temp-sai-left")
        ].map(b => {
            b = parseInt(b, 10);
    ...
    async _OnRequestWakeLock() {
        if (!this._screenWakeLock) try {
            ...
            console.warn("[Construct 3] Failed to acquire screen wake lock: ", d), this.PostToRuntime("wake-lock-error")
        }
    }
    _OnReleaseWakeLock() {
    ...
    self.AudioDOMHandler = class extends self.DOMHandler {
        ...
        async _OnOfflineRenderAudio(a) {
            try {
                ...
                this._hasStartedOfflineRender ? this._audioContext.resume() : (this._audioContext.startRendering().then(e =>
                    this._OnOfflineRenderCompleted(e)).catch(e => this._OnOfflineRenderError(e)), this._hasStartedOfflineRender = !0);
                await b
            } catch (b) {
